...
def create_dictionary(dataroot, task='vsrl'):
...
if __name__ == '__main__':
    ...
    dictionary_path = os.path.join(dataroot, 'dictionary_imsitu.pkl')
    ...
    np.save(os.path.join(dataroot, 'glove6b_init_imsitu_%dd.npy' % emb_dim), weights)
