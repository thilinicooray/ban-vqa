        ...
        for i, (id, img, verb, labels) in enumerate(train_loader):
            ...
            if total_steps % eval_frequency == 0:
                ...
                if max_score == dev_score_list[-1]:
                    torch.save(model.state_dict(), model_dir + "/{}_verbq_iter0_ban.model".format( model_name))
...
def main():
    ...
    imsitu_roleq = json.load(open(dataset_folder +"/imsitu_questions_prev.json"))
    encoder = imsitu_encoder(train_set, imsitu_roleq, dataset_folder)
